  ...
  return (
    <section className="flex items-center justify-center p-4 mt-20 sm:p-6 md:p-8 relative">
      <div className="max-w-3xl w-full space-y-6 sm:space-y-8 px-2 sm:px-4">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-2xl border border-slate-700 text-center space-y-4 sm:space-y-5 md:space-y-6 transition-transform duration-300">
          ...
          <button className="bg-linear-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold text-sm sm:text-base md:text-lg h-11 sm:h-12 md:h-14 px-6 sm:px-8 md:px-12 rounded-lg sm:rounded-xl flex items-center justify-center gap-2 mx-auto transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]">
